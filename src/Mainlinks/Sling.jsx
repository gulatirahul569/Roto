...
const Sling = () => {
  ...
  const filteredProducts =
    selectedCategory === "All"
      ? Sling_products
      : Sling_products.filter((item) => item.category === selectedCategory);
    ...
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-white">
      ...
      <div className="bg-linear-to-b from-white to-gray-100 py-10">
        ...
        <div className="text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold uppercase tracking-widest border-b inline-block mt-2 mb-6">
            SLINGS
          </h1>
          <p className="text-gray-400 mt-0 text-sm">
            Minimal • Premium • Everyday Carry
          </p>
        </div>
